//! OpenMLS provider integration with Sunder's Environment abstraction.
//!
...
/// Sunder's OpenMLS provider that uses our Environment trait for RNG.
///
/// This provider integrates OpenMLS with Sunder's Sans-IO architecture:
///
...
pub struct SunderMlsProvider<E: Environment> {
...
impl<E: Environment> SunderMlsProvider<E> {
...
impl<E: Environment> OpenMlsProvider for SunderMlsProvider<E> {
